...
namespace EditorAttributes
{
    public class TitleAttribute : PropertyAttribute, IDynamicStringAttribute
    {
        ...
        public TitleAttribute(string title, int titleSize = 20, bool drawLine = true, TextAnchor alignment = TextAnchor.MiddleLeft, StringInputMode stringInputMode = StringInputMode.Constant) : base(true)
        {
            Title = title;
            TitleSize = titleSize;
            DrawLine = drawLine;
