...
namespace Lachee.Utilities.Serialization
{
    ...
    public enum UClassID
    {
        ...
        WebPlayerTemplates = 1046,
        BuildPlayerWindow = 1047,
        ...
        ActivationProperties = 1128,
        WebPluginImporter = 1129,
        GPUSkinningMode = 1130,
        RenderPass = 1131,
        MaterialQuality = 1132,
        SingleChannel = 1133,
        SplitChannels = 1134,
        CombinedChannels = 1135,
        AlphaChannel = 1136,
        RenderQueue = 1137,
        RenderBufferLoadAction = 1138,
        RenderBufferStoreAction = 1139,
        ShaderChannel = 1140,
        RenderPlatform = 1141,
        TextureUsageMode = 1142,
        ResizableWindow = 1143,
        DisplayResolution = 1144,
        Int = 100000,
        Bool = 100001,
        Float = 100002,
        MonoObject = 100003,
